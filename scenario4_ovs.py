...
def topology():
    ...
    """Create Queues"""
    ap1.cmd("ovs-vsctl -- set port ap1-eth6 qos=@newqos -- --id=@newqos create qos type=linux-htb other-config:max-rate=1000000000 queues:1=@q1 queues:2=@q2 queues:3=@q3 queues:4=@q4 queues:5=@q5 queues:6=@q6 -- --id=@q1 create queue other-config:min-rate=128000 other-config:max-rate=128000 -- --id=@q2 create queue other-config:min-rate=512000 other-config:max-rate=512000 -- --id=@q3 create queue other-config:min-rate=1000000 other-config:max-rate=1000000 -- --id=@q4 create queue other-config:min-rate=4000000 other-config:max-rate=4000000 -- --id=@q5 create queue other-config:min-rate=10000000 other-config:max-rate=10000000 -- --id=@q6 create queue other-config:min-rate=40000000 other-config:max-rate=40000000")
