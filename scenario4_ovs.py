...
def topology():
    ...
    info("*** Creating nodes\n")
    sta1 = net.addStation( 'sta1', wlans=1, mac='00:00:00:00:00:01', ip="192.168.0.100/24" )
    sta2 = net.addStation( 'sta2', wlans=1, mac='00:00:00:00:00:02', ip="192.168.0.101/24" )
    sta3 = net.addStation( 'sta3', wlans=1, mac='00:00:00:00:00:03', ip="192.168.0.102/24" )
    sta4 = net.addStation( 'sta4', wlans=1, mac='00:00:00:00:00:04', ip="192.168.0.103/24" )
    ...
    ap1.cmd("ovs-ofctl -O OpenFlow11 add-flow ap1 priority=65535,ip,dl_type=0x0800,in_port=6,actions=pop_vlan,output:2")
    ap1.cmd("ovs-ofctl -O OpenFlow11 add-flow ap1 priority=65535,ip,dl_type=0x0800,in_port=6,actions=pop_vlan,output:3")
    ap1.cmd("ovs-ofctl -O OpenFlow11 add-flow ap1 priority=65535,ip,dl_type=0x0800,in_port=6,actions=pop_vlan,output:4")
    ap1.cmd("ovs-ofctl -O OpenFlow11 add-flow ap1 priority=65535,ip,dl_type=0x0800,in_port=6,actions=pop_vlan,output:5")
    """
    """VLAN BASED ROUTING"""
    ...
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_vlan=4,dl_src=00:00:00:00:00:01,dl_dst=00:00:00:00:02:00,actions=pop_vlan,goto_table:1")
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_vlan=2,dl_src=00:00:00:00:00:02,dl_dst=00:00:00:00:02:00,actions=pop_vlan,goto_table:2")
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_vlan=3,dl_src=00:00:00:00:00:03,dl_dst=00:00:00:00:02:00,actions=pop_vlan,goto_table:3")
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_vlan=4,dl_src=00:00:00:00:00:04,dl_dst=00:00:00:00:02:00,actions=pop_vlan,goto_table:1")

    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_src=00:00:00:00:02:00,dl_dst=00:00:00:00:00:01,actions=goto_table:1,actions=push_vlan:0x8100,set_field:4-\>vlan_vid")
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_src=00:00:00:00:02:00,dl_dst=00:00:00:00:00:02,actions=goto_table:2,actions=push_vlan:0x8100,set_field:2-\>vlan_vid")
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_src=00:00:00:00:02:00,dl_dst=00:00:00:00:00:03,actions=goto_table:3,actions=push_vlan:0x8100,set_field:3-\>vlan_vid")
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_src=00:00:00:00:02:00,dl_dst=00:00:00:00:00:04,actions=goto_table:1,actions=push_vlan:0x8100,set_field:4-\>vlan_vid")

    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,dl_src=00:00:00:00:02:00,actions=pop_vlan,goto_table:3")
    ...
    s1.cmd("ovs-ofctl add-flow s1 table=1,priority=65535,ip,dl_type=0x0800,nw_proto=6,tp_src=80,nw_src=100.100.100.100,actions=set_queue:7,normal")
    s1.cmd("ovs-ofctl add-flow s1 table=1,priority=65535,ip,dl_type=0x0800,nw_proto=17,tp_src=3001,nw_src=100.100.100.100,actions=set_queue:8,normal")
    s1.cmd("ovs-ofctl add-flow s1 table=1,priority=65535,ip,dl_type=0x0800,nw_proto=6,tp_src=5001,nw_src=100.100.100.100,actions=set_queue:9,normal")

    s1.cmd("ovs-ofctl add-flow s1 table=1,priority=1,ip,dl_dst=00:00:00:00:02:00,actions=normal")

    s1.cmd("ovs-ofctl add-flow s1 table=1,priority=1,ip,dl_src=00:00:00:00:02:00,actions=normal")
    ...
    s1.cmd("ovs-ofctl add-flow s1 table=2,priority=65535,ip,dl_type=0x0800,nw_proto=6,tp_src=80,nw_src=100.100.100.100,actions=set_queue:4,normal")
    s1.cmd("ovs-ofctl add-flow s1 table=2,priority=65535,ip,dl_type=0x0800,nw_proto=17,tp_src=3001,nw_src=100.100.100.100,actions=set_queue:5,normal")
    s1.cmd("ovs-ofctl add-flow s1 table=2,priority=65535,ip,dl_type=0x0800,nw_proto=6,tp_src=5001,nw_src=100.100.100.100,actions=set_queue:6,normal")

    s1.cmd("ovs-ofctl add-flow s1 table=2,priority=1,ip,dl_dst=00:00:00:00:02:00,actions=normal")

    s1.cmd("ovs-ofctl add-flow s1 table=2,priority=1,ip,dl_src=00:00:00:00:02:00,actions=normal")
    ...
    s1.cmd("ovs-ofctl add-flow s1 table=3,priority=65535,ip,dl_type=0x0800,nw_proto=6,tp_src=80,nw_src=100.100.100.100,actions=set_queue:1,normal")
    s1.cmd("ovs-ofctl add-flow s1 table=3,priority=65535,ip,dl_type=0x0800,nw_proto=17,tp_src=3001,nw_src=100.100.100.100,actions=set_queue:2,normal")
    s1.cmd("ovs-ofctl add-flow s1 table=3,priority=65535,ip,dl_type=0x0800,nw_proto=6,tp_src=5001,nw_src=100.100.100.100,actions=set_queue:3,normal")

    s1.cmd("ovs-ofctl add-flow s1 table=3,priority=1,ip,dl_dst=00:00:00:00:02:00,actions=normal")

    s1.cmd("ovs-ofctl add-flow s1 table=3,priority=1,ip,dl_src=00:00:00:00:02:00,actions=normal")
